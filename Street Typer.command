...
#   right-click this file -> Open  (or in Terminal: chmod +x "Street Typer.command")
cd "$(dirname "$0")" || exit 1
for c in python3 python; do
  if command -v "$c" >/dev/null 2>&1; then
    echo "Starting Street Typer... your browser will open. Keep this window open while you play."
